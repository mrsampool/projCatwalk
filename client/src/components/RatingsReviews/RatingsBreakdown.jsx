...
export const RatingsBreakdown = (props) => {
  ...
  return (
    <div id='RatingBreakdown' onClick={addFilter} >
      ...
      <h5 id='5stars'>5 stars</h5> <meter min='0' max='1' value={reviewsMetadata.ratings['5'] ? reviewsMetadata.ratings['5'] / totalRatingsQty : 0} data-testid='starmeter'></meter>
      <h5 id='4stars'>4 stars</h5> <meter min='0' max='1' value={reviewsMetadata.ratings['4'] ? reviewsMetadata.ratings['4'] / totalRatingsQty : 0} data-testid='starmeter'></meter>
      <h5 id='3stars'>3 stars</h5> <meter min='0' max='1' value={reviewsMetadata.ratings['3'] ? reviewsMetadata.ratings['3'] / totalRatingsQty : 0} data-testid='starmeter'></meter>
      <h5 id='2stars'>2 stars</h5> <meter min='0' max='1' value={reviewsMetadata.ratings['2'] ? reviewsMetadata.ratings['2'] / totalRatingsQty : 0} data-testid='starmeter'></meter>
      <h5 id='1stars'>1 stars</h5> <meter min='0' max='1' value={reviewsMetadata.ratings['1'] ? reviewsMetadata.ratings['1'] / totalRatingsQty : 0} data-testid='starmeter'></meter>
