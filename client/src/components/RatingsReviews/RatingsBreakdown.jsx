...
export const RatingsBreakdown = (props) => {
  ...
  if (Object.keys(props.filter).length > 0) {
    console.log('props.filter length is greater than 0')
    clearFilterBtn = (
  ...
  return (
    <div id='RatingBreakdown' onClick={addFilter} >
      ...
      <h5 id='5stars'>5 stars</h5> <meter min='0' max='1' value={reviewsMetadata.ratings['5'] / totalRatingsQty} data-testid='starmeter'></meter>
      <h5 id='4stars'>4 stars</h5> <meter min='0' max='1' value={reviewsMetadata.ratings['4'] / totalRatingsQty} data-testid='starmeter'></meter>
      <h5 id='3stars'>3 stars</h5> <meter min='0' max='1' value={reviewsMetadata.ratings['3'] / totalRatingsQty} data-testid='starmeter'></meter>
      <h5 id='2stars'>2 stars</h5> <meter min='0' max='1' value={reviewsMetadata.ratings['2'] / totalRatingsQty} data-testid='starmeter'></meter>
      <h5 id='1stars'>1 stars</h5> <meter min='0' max='1' value={reviewsMetadata.ratings['1'] / totalRatingsQty} data-testid='starmeter'></meter>
